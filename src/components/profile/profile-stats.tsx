    ...
    return (
        <>
            ...
            >
                ...
                {isLoading ? <div className="h-8 w-12 bg-background-800 dark:bg-neutral-700 animate-pulse corner-squircle rounded-md" /> : <h2 className="text-3xl font-semibold">{stats ? stats.likes : 0}</h2>}
            </div>
            <div
                className="flex flex-col items-center gap-1"
                title="Uploads"
            ...
            >
                ...
                {isLoading ? <div className="h-8 w-12 bg-background-800 dark:bg-neutral-700 animate-pulse corner-squircle rounded-md" /> : <h2 className="text-3xl font-semibold">{stats ? stats.uploaded : 0}</h2>}
            </div>
        </>
    );
}
