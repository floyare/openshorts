...
function WebsiteItem({ website }: WebsiteItemProps) {
    ...
    return (
        <div className="px-6 py-4 max-w-lg rounded-sm border-[1px] border-background-800 bg-background-950 w-full flex flex-col gap-2 grow relative">
            <div className="grid grid-cols-[1fr_auto] gap-1 bg-accent-700">
                <div className="flex flex-col gap-2 bg-yellow-200 col-span-1 w-full">
                    <a href={website.url} target="_blank" className="flex items-center gap-4 cursor-pointer hover:bg-primary-700/20 transition-colors rounded-sm w-fit">
                        ...
                        <h2 className="font-bold text-2xl flex items-center gap-1 relative bg-green-300 w-full">
                            <span className="truncate inline-block !w-[88%] bg-red-400">{name}</span>
                    ...
                    <p className="w-full overflow-hidden text-ellipsis [display:-webkit-box] [-webkit-line-clamp:6] [-webkit-box-orient:vertical] bg-blue-300">
                        {description}
                    </p>
                ...
                <div className="flex flex-col items-end gap-2 bg-orange-300 w-fit ml-auto">
