            ...
            <div className="flex flex-col items-center justify-center flex-wrap gap-2 p-4">
                ...
                {filteredPosts.map((post: any) => (
                    <a
                        ...
                        className="flex items-center relative overflow-hidden md:min-w-xl min-w-full bg-white dark:bg-neutral-950 px-8 py-6 rounded-md no-underline gap-8 border-[1px] border-transparent hover:border-primary-500 transition-colors"
                    >
                        ...
                        <img
                            className="relative lg:block hidden w-3xs z-0"
