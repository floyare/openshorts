const HomeWebsitesBox = ({ icons }: { icons: { url: string }[] }) => {
    return (
        <div className="grid md:grid-cols-9 grid-cols-8 grid-rows-4 md:gap-6 gap-3 bg-white dark:bg-neutral-900 dark:border-neutral-700 p-4 corner-squircle rounded-md border-1 border-neutral-200">
            {icons.map((_, index) => (
